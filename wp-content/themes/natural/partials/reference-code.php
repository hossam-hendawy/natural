...
<?php if (!empty($cta_button) && is_array($cta_button)) { ?>
  <a class="cta-button has-icon" href="<?= $cta_button['url'] ?>" target="<?= $cta_button['target'] ?>"><?= $cta_button['title'] ?>
...
<?php if (!empty($cta_button) && is_array($cta_button)) { ?>
  <a class="cta-link" href="<?= $cta_button['url'] ?>" target="<?= $cta_button['target'] ?>"><?= $cta_button['title'] ?>
...
<div class="all-locations horizontal-card">
  <div class="top-content">
    <h5 class="map-h5 white-color capital-text">List View</h5>
    <div class="arrow">
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
        <path d="M24.0498 9.8833L34.1665 20L24.0498 30.1166" stroke="white" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M5.8335 20H33.8835" stroke="white" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
        <path d="M15.9502 9.8833L5.83353 20L15.9502 30.1166" stroke="white" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M34.1665 20H6.1165" stroke="white" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    </div>
  </div>
  <div class="cards-box">
    ...
    <div class="location-card">
      <a href="#" class="featured-image-wrapper">
        <picture class="aspect-ratio">
          <img src="<?= get_template_directory_uri() . '/images/location1.png' ?>" alt="location1">
        </picture>
      </a>
      <div class="location-information">
        <picture class="logo-wrapper">
          <img src="<?= get_template_directory_uri() . '/images/logo.png' ?>" alt="location1">
        </picture>
        <a href="#" class="map-h6 post-title">Performance Food Group Cold Storage Distribution Center</a>
        <div class="map-h6 square-ft">94,000 SF</div>
        <a href="#" class="cta-link">View Details
          <svg viewBox="0 0 41 40" fill="none" aria-hidden="true">
            <path d="M24.7168 9.8833L34.8335 20L24.7168 30.1166" stroke="white" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M6.50049 20H34.5505" stroke="white" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
          </svg>
        </a>
      </div>
    </div>
