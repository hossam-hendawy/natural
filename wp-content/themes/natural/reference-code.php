    ...
    <div class="col-6 col-md-3">
      <div class="testimonials-card">
        ...
        <div class="title body-2 navy-color medium">
          “map provide an excellent service over the phone and on site, every job gets treated with the same high
          standard
    ...
    <div class="col-6 col-md-3">
      <div class="testimonials-card has-image">
        ...
        <div class="card-info">
          ...
          <div class="jop-title captions regular navy-color  navy-tint-color">Commercial Director map Systems</div>
        </div>
      </div>
    </div>
  </div>
